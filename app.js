...
mongoose.connect(process.env.MONGODB_URI || 'mongodb+srv://mayank:bakery@cluster0.ofbdy.mongodb.net/models?retryWrites=true&w=majority ', { useUnifiedTopology: true, useNewUrlParser: true },function(){
